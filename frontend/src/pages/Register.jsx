  ...
  return (
    <div className="flex h-screen items-center justify-center bg-ink font-body">
      <div className="w-full max-w-sm rounded-xl bg-white p-8 shadow-xl">
        <h1 className="mb-1 font-display text-2xl font-bold text-slate-900">Create your account</h1>
        <p className="mb-6 text-sm text-slate-500">
          The first account created becomes the workspace admin. Admins add teammates afterwards.
        </p>
